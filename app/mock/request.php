...
/* 
 Este archivo fue sacado de un modulo de Sao:
 https://github.com/4rcan31/Sao/tree/main/core/Http/request.php
...
/*         Request::$tokenRequest = randomString(10);  */
    ...
    public static function data(){
        $dataRequestInput = (array) json_decode(file_get_contents("php://input"));
        ...
        if (!empty($dataRequestInput)) {
            $data = array_merge($dataRequestInput, $data);
        }
